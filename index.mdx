...
Dvuln is a comprehensive vulnerability management platform that helps security teams track, manage, and remediate security issues across their organization.
...
<Columns cols={2}>
  <Card
    ...
    href="/quickstart"
  >
    Get up and running with Dvuln in minutes. Create your first project and start tracking vulnerabilities.
  </Card>
  <Card
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="webhook"
  >
    Coming soon - Real-time notifications for issue updates
  </Card>
</Columns>
